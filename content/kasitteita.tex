...
tieteenalan ja -haaran näkökulmasta sitä tarkastellaan. Tässä tutkielmassa
...
tyyppitarkastettuihin (puhekielessä usein \dblquoted{staattisesti ja dynaamisesti
tyypitettyihin}) perustuu ohjelman kehitysvaiheeseen, jossa tarkastaminen
...
\inlinecode{\dblquoted{teksti} + 2} ohjelmaa
