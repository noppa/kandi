...
function varaaAikaEläinlääkäriin(omistaja: Ihminen, lemmikki: Eläin) { }

varaaAikaEläinlääkäriin(new Eläin("Musti"), new Ihminen("Jaakko"));
\end{lstlisting}
...
TypeScript pyrkii noudattamaan mahdollisimman tarkasti
EcmaScript-spesifikaatiossa kaikkien sellaisten ominaisuuksien suhteen, jotka
