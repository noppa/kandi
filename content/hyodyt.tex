...
Listauksessa \ref{fig:optimoitu_javascript} puolestaan näkyy Closuren
tuottama koodi. Pitkä luokkamuuttuja \inlinecode{ostostenHintaYhteensa}
on uudelleennymetty lyhyeen muottoon \inlinecode{\$a\$}. Closure näkee
...
(engl. function inlining). \inlinecode{arvonLisaVero}-luokkamuuttuja
on poistettu ja korvattu \inlinecode{.14} \textit{numeroliteraalilla},
mikä paitsi pienentää koodin kokoa myös saattaa parantaa suorituksenaikaista
tehokkuutta, sillä selainmoottorin ei tarvitse noutaa \inlinecode{arvonLisaVero}
...
\dblquoted{debugattaessa} käännetty koodi voidaan palauttaa alkuperäiseen
