...
ja vaikutus kehitysprosessiin riippuu käytetystä kielestä,
EcmaScript versiosta ja siitä missä ympäristöissä sitä halutaan suorittaa.
Esimerkiksi Internet Explorer tukee ainoastaan EcmaScriptin vanhaa viidettä
versiota (2011). Jos koodi kirjoitetaan kaikkiin
suoritusympäristöihin soveltuvalla kielen versiolla,
